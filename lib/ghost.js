...
class Ghost extends MovableObject {
  ...
  goHome(board, quackMan, grid, squareWidth, squareHeight){
    ...
    // const endX = 7;
    // const endY = 9; // make these the default positions
    // while(!(Math.abs(this.x - (squareWidth * startX)) <=5 ) && !(Math.abs(this.y - (squareHeight * startY)) <=5 )){
