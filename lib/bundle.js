  ...
  static fromString(ctx, boardModel){
    ...
    const mappedGrid = grid.map((row, rowIdx) => {
      return row.map((cell, cellIdx) => {
        ...
        return __WEBPACK_IMPORTED_MODULE_0__util__["a" /* default */].mazeFactory(cell, x, y, width, height);
      });
    });
...
class Util {
  ...
  static mazeFactory(string, x, y, width, height){
    ...
    switch (string) {
      case "X":
        return new __WEBPACK_IMPORTED_MODULE_0__wall__["a" /* default */](x, y, width, height);
      default:
