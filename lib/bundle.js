...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const movingObject = __WEBPACK_IMPORTED_MODULE_0__board_js__["a" /* default */].fromString(ctx, __WEBPACK_IMPORTED_MODULE_1__board_model_js__["a" /* default */]);
  movingObject.draw();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__draw_strategy__ = __webpack_require__(11);
      ...
      row.forEach((cell, cellIdx) => {
        if(cell instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
          ...
          if(nextHorz instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawRightWall);
          } else if(prevHorz instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawRightCap);
          }
          if(prevHorz instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawLeftWall);
          } else if(nextHorz instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawLeftCap);
          }
          if(nextVert instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawBottomWall);
          } else if(prevVert instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawBottomCap);
          }
          if(prevVert instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawTopWall);
          } else if(nextVert instanceof __WEBPACK_IMPORTED_MODULE_1__wall__["a" /* default */]){
            cell.addDrawStrategy(__WEBPACK_IMPORTED_MODULE_2__draw_strategy__["a" /* default */].drawTopCap);
          }
        }
      });
    });
